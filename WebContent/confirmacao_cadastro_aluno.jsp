                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <div class="text-center">
                                ...
                                <h3 class="h6 text-gray-900 mb-4">Sua solicitação de cadastro foi enviada!</h3>
                                <h3 class="h6 text-gray-900 mb-4">
                                Agora, é só aguardar para ter a sua conta liberada para o uso, através de um email com a senha e instruções, enviados pelo seu professor.
                                </h3>
                                <h3 class="h6 text-gray-900 mb-4">
                                Em caso de dúvidas, contate seu professor de turma ou a secretaria do seu colegiado.
                                </h3>
                            </div>
                            <%} else {%>
                            <div class="text-center">
                                <h1 class="h5 text-gray-900 mb-4"> Houve um erro com a sua solicitação de cadastro!</h1>
                                <h3 class="h6 text-gray-900 mb-4">Você pode tentar cadastra-se novamente ou contatar seu professor de turma ou a secretaria do seu colegiado.</h3>
                            </div>                            
                            <%}%>
                            <div class="text-center">
