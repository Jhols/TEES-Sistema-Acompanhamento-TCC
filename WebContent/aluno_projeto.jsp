...
<div class="container-fluid">
	...
	%>	
		...
		<form action="" method="POST" id="" class="form-group" style="width:425px">
			<fieldset style="border:1">
				...
				<div><input type=submit id="" class="btn btn-primary btn-icon-split btn-lg" name="" onClick="" style="float:right; padding: 5px; margin-left: 10px" value="Enviar Relatório" /></div>
	...
	else { //Se não houver projeto associado...
		System.out.println("Projeto associado nao encontrado!");
		%>
		<div>
			<h3>Ops... Você ainda não possui um projeto ativo!</h3>
			<h4>Clique no botão abaixo para se inscrever em um novo projeto.</h4>
	
			<a class="btn btn-primary btn-icon-split btn-lg"
				href="ProjetoServlet?opcao=listar"> <span class="text">Procurar
					Projetos Disponíveis</span>
			</a>
		</div>
	<%}%>
</div>
